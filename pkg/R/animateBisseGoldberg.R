...
#
showBisseMovie<-function(q0=0.0,q1=0.555,b0=5.199,b1=2.933,d0=5.433,d1=2.319) {
  quartz()
...
saveBisseMovie<-function(q0=0.0,q1=0.555,b0=5.199,b1=2.933,d0=5.433,d1=2.319) {
