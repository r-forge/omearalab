...
#F=focal states
doUnifiedRun<-function(F=F, T=T,D=D,S=partitionSize,find.mle.method="subplex") {
	startTime<-proc.time()
	...
	fit.final <- find.mle(lik.final,p,method=find.mle.method,hessian=TRUE) #the hessian lets us get standard errors
