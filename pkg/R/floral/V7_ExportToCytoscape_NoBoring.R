...
load("/Users/bomeara/Documents/MyDocuments/Active/FloralAssembly/RunsJan2012/Summaries/all.results.cleaned.Rsave") #replace with frame of all data
...
print(qDataFrame)
write.table(qDataFrame,file="/Users/bomeara/Documents/MyDocuments/Active/FloralAssembly/RunsJan2012/Summaries/Cytoscape_edges_NoBoring.txt",quote=FALSE,sep="\t",row.names=FALSE,col.names=TRUE)
...
print(ndf3)
write.table(ndf3,file="/Users/bomeara/Documents/MyDocuments/Active/FloralAssembly/RunsJan2012/Summaries/Cytoscape_nodes_NoBoring.txt",quote=FALSE,sep="\t",row.names=FALSE,col.names=TRUE)
