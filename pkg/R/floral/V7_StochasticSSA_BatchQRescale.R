...
MakeRunFiles(constraint="full", net.div=FALSE, tf=75, submit=TRUE, nrep=50, best.only=TRUE, x0.rescale=x0.rescale, x0=x0, q.rescale=10)
MakeRunFiles(constraint="full", net.div=FALSE, tf=75, submit=TRUE, nrep=50, best.only=FALSE, x0.rescale=x0.rescale, x0=x0, q.rescale=10)
