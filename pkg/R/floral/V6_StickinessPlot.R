...
source("~/Documents/MyDocuments/Active/FloralAssembly/RunsJan2012/UnifiedApproachScripts/V6_UtilityFns.R")
load("~/Documents/MyDocuments/Active/FloralAssembly/RunsJan2012/Summaries/Highlevel.dataframe.withrates.Rsave") #replace with frame of all data
...
print(qDataFrame)
#write.table(qDataFrame,file="Documents/MyDocuments/Active/FloralAssembly/RunsJan2012/Summaries/Cytoscape_edges.txt",quote=FALSE,sep="\t",row.names=FALSE,col.names=TRUE)


#get info on number of combos
sourcetraits="~/Documents/MyDocuments/Active/FloralAssembly/RunsJan2012/SourceData/Stebbins_prunenoper25i2012BCO.csv"
file<-sourcetraits
phy<-"~/Documents/MyDocuments/Active/FloralAssembly/RunsJan2012/SourceData/floral_1.nex"
tree<-read.nexus(phy)
data<-read.csv(file)
